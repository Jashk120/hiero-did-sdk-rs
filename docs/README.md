...
2. Read `resolve-did.md` for the resolution pipeline and transport options.
3. Read `dereference-did.md` for fragment/resource dereference behavior.
4. Use `api-reference.md` while integrating crate APIs.
5. Read `testing.md` before running integration suites.
